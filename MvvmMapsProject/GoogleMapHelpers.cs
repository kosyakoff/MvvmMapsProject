namespace MvvmMapsProject
{
    ...
    public static class GoogleMapHelpers
    {
        ...
        private static readonly string[] PERMISSIONS_LOCATION = { Manifest.Permission.AccessFineLocation, Manifest.Permission.AccessCoarseLocation };

        private static readonly string TAG = "GoogleMapHelpers";
        ...
        public static bool HasLocationPermissions(this Activity activity)
        {
            ...
            foreach (string p in PERMISSIONS_LOCATION)
        ...
        public static bool MustShowPermissionRationale(this Activity activity)
        {
            ...
            foreach (string perm in PERMISSIONS_LOCATION)
